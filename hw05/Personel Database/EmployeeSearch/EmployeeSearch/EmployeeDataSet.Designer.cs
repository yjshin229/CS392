...
namespace EmployeeSearch.EmployeeDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([Id] = @Original_Id) AND ([PayRate] = @Origi" +
                "nal_PayRate))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([Name], [Position], [PayRate]) VALUES (@Name, @Posi" +
                "tion, @PayRate);\r\nSELECT Id, Name, Position, PayRate FROM Employee WHERE (Id = S" +
                "COPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employee] SET [Name] = @Name, [Position] = @Position, [PayRate] = @" +
                "PayRate WHERE (([Id] = @Original_Id) AND ([PayRate] = @Original_PayRate));\r\nSELE" +
                "CT Id, Name, Position, PayRate FROM Employee WHERE (Id = @Id)";
        ...
        public virtual int Delete(int Original_Id, decimal Original_PayRate) {
        ...
        public virtual int Update(string Name, string Position, decimal PayRate, int Original_Id, decimal Original_PayRate, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Position, decimal PayRate, int Original_Id, decimal Original_PayRate) {
            return this.Update(Name, Position, PayRate, Original_Id, Original_PayRate, Original_Id);
        }
    }
