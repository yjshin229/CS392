...
namespace Personnel_Database {
    ...
    public partial class EmployeeDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeeRow AddEmployeeRow(string Name, string Position, decimal PayRate) {
        ...
        public partial class EmployeeRow : global::System.Data.DataRow {
            ...
            public decimal PayRate {
                get {
                    return ((decimal)(this[this.tableEmployee.PayRateColumn]));
                }
                set {
...
namespace Personnel_Database.EmployeeDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([Name], [Position], [PayRate]) VALUES (@Name, @Posi" +
                "tion, @PayRate);\r\nSELECT EmployeeId, Name, Position, PayRate FROM Employee WHERE" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Name] = @Name, [Position] = @Position, [PayRate] = @PayRate WHERE (([EmployeeId] = @Original_EmployeeId) AND ([PayRate] = @Original_PayRate));
SELECT EmployeeId, Name, Position, PayRate FROM Employee WHERE (EmployeeId = @EmployeeId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeId, Name, Position, PayRate FROM dbo.Employee";
        ...
        public virtual int Delete(int Original_EmployeeId, decimal Original_PayRate) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_EmployeeId));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((decimal)(Original_PayRate));
        ...
        public virtual int Insert(string Name, string Position, decimal PayRate) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Position, decimal PayRate, int Original_EmployeeId, decimal Original_PayRate, int EmployeeId) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((decimal)(Original_PayRate));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Position, decimal PayRate, int Original_EmployeeId, decimal Original_PayRate) {
            return this.Update(Name, Position, PayRate, Original_EmployeeId, Original_PayRate, Original_EmployeeId);
        }
    }
